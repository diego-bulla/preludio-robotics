...
class RobotSeguidorLinea:
    def __init__(self):
        # Limpiar recursos GPIO antes de cualquier configuración
        GPIO.cleanup()  # <--- ¡Crítico para resolver "GPIO busy"!
        
        # Configuración inicial GPIO
        GPIO.setmode(GPIO.BCM)
        GPIO.setwarnings(False)
        
        # Pines para QTR-8RC (verificar que no sean SPI/I2C)
        self.SENSOR_PINS = [24, 25, 8, 7, 12, 16, 20, 21]  # GPIO 8 y 7 requieren desactivar SPI
        ...
        self.umbral = 0.5          # Umbral para línea negra
    ...
    def calcular_posicion(self, valores):
        ...
        total = sum(i*1000 for i, val in enumerate(valores) if val)
