...
class RobotControl:
    def __init__(self):
        ...
        # Pines de motores (usando tu configuración que funciona)
        self.ENA = 26
        self.IN1 = 19
        self.IN2 = 13
        self.ENB = 11
        ...
        # Control de motores
        self.BASE_SPEED = 70         # Velocidad base (0-100)
        self.MIN_SPEED = 40          # Velocidad mínima para movimiento
        self.ROTATION_SPEED = 50     # Velocidad de giro en búsqueda
        ...
        # Tiempos
        self.SEARCH_DELAY = 0.2      # Tiempo entre ajustes en búsqueda

    def setup_motores(self):
        # Configuración de pines (igual a tu versión que funciona)
        motor_pins = [self.ENA, self.IN1, self.IN2, self.ENB, self.IN3, self.IN4]
        for pin in motor_pins:
            GPIO.setup(pin, GPIO.OUT)
            GPIO.output(pin, GPIO.LOW)

        # Configurar PWM con frecuencia de 1kHz (como en tu versión funcional)
    ...
    def control_motores(self, izq, der):
        # Función probada de tu código original con ajustes de seguridad
